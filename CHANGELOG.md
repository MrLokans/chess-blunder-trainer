...
### Added
- **Game links**: Links to the original game on Lichess/Chess.com from analysis and trainer views

### Changed
- **Accuracy metric**: Replaced Centipawn Loss (CPL) metrics with Accuracy percentage across dashboard and analysis
