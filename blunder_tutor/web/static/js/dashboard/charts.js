function sharedChartOptions(xAxisConfig = {}) {
  return {
    responsive: true,
...
function datasets(labels, gameCounts, accuracies) {
  return {
    labels,
    datasets: [
      {
...
export function createDateChart(ctx, labels, gameCounts, accuracies) {
...
export function createHourChart(ctx, labels, gameCounts, accuracies) {
  return new Chart(ctx, {
    type: 'bar',
    data: datasets(labels, gameCounts, accuracies),
    options: sharedChartOptions({
